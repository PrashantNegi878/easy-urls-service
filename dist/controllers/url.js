...
exports.handleAnalytics = exports.handleRedirect = exports.generateShortURL = void 0;
...
function handleAnalytics(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return res.json({ redirectUrl: entry.redirectUrl, totalClicks: entry.visitHistory.length, timeEntries: entry.visitHistory });
    });
}
